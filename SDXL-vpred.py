...
if "sd" in modules and not sd_use_remote:
    ...
    print("Initializing Stable Diffusion XL Vpred pipeline...")
    ...
    if args.lowvram :
      sd_pipe = StableDiffusionXLPipeline.from_single_file(ckpt_path, custom_pipeline="uooogh/lpw_stable_diffusion_xl", use_safetensors=True, torch_dtype=torch.float16,)
